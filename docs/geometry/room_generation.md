...
The door is generated pointed at the hubs, rather than at any one room or at nowhere at all. Where a door goes is written on the door, and one that names nowhere is locked — so a generated room whose way in was left unwired would be a room its visitors could not leave. Naming the hubs without naming one of them is what generation can honestly decide here: which hub is worth arriving in belongs to the moment somebody walks through, not to the day the room was built (see [room_entrance.md](room_entrance.md#what-a-door-carries)).
