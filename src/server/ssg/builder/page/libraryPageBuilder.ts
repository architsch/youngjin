...
export default class LibraryPageBuilder
{
    ...
    addPostLinks(builder: TextFileBuilder, title: string, entries: PostEntry[]): void
    {
        ...
        for (let i = entries.length - 1; i >= 0; --i)
        {
            ...
            builder.addLine(`<a class="postEntryButton" href="${process.env.ROOT_URL}/${entry.dirName}/list.html">${entry.title}</a>`);
        }
    }
    ...
    async build(): Promise<void>
    {
        ...
        builder.addLine(await EJSUtil.createStaticHTMLFromEJS("partial/common/header.ejs", {
            ...
            backDestination_href: process.env.ROOT_URL,
        }));
        ...
        // Each "menu" page must support both static and dynamic page load.
        await builder.build("library.html");
        builder.prependLine("<!-- NOTE: This EJS file is auto-generated by 'libraryPageBuilder.ts' -->");
        await builder.build("page/menu/library.ejs", process.env.VIEWS_ROOT_DIR);
