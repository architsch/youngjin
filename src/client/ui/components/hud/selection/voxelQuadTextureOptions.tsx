...
export default function VoxelQuadTextureOptions(props: {selection: VoxelQuadSelection})
{
    ...
    return <div id="voxelQuadTextureOptions" ref={onRefChange} className="flex flex-row gap-2 p-2 w-full overflow-x-auto no-scrollbar pointer-events-auto bg-gray-800 rounded-md yj-surface-convex">
