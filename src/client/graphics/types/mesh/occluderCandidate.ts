...
// piece of geometry a sample happened to strike, since an object drawn out of many parts covers the
// target with all of them together, and goes out of sight as a whole if it goes at all.
export default interface OccluderCandidate
{
    ...
    // The object the struck piece belongs to. Geometry belonging to none is never a candidate: only
    // an object can declare itself something a camera may take out of the room (see OrbitOccluder).
