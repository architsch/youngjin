...
// parameters and how it is built — because the server generates that room too, while nothing on the
// server has any use for the steps. Separating them is also what lets a step reach straight for the
// room, the character, the camera and this mode's own variables: all of them the client's alone, and
// none of them reachable from shared code.
