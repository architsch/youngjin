...
const testActions_room = require("../testActions/testActions_room");

const testRoutine_room = async () => {
    const numUsers = 12;
    const numRooms = 4;
    ...
    for (let i = 0; i < numRooms; ++i)
        rooms.push({roomName: `testRoom ${i}`, roomOwnerName: null});
...
module.exports = testRoutine_room;